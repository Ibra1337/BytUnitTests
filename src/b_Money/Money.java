...
public class Money implements Comparable {
	...
	public Money add(Money other) {
		...
		int amount = currency.valueInThisCurrency(other.amount , other.currency) + this.amount;
	...
	public Money sub(Money other) {
		int amount = this.amount - currency.valueInThisCurrency(other.amount , other.currency)  ;
		return new Money(amount , this.currency);
	}
	/**
	...
	public int compareTo(Object other) {
		...
		if (this.currency.universalValue(amount) - m.currency.universalValue(m.amount ) >0)
		{
			return 1;
		};
		return  -1;
